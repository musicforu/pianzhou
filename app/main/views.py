...
def edit_profile():
	...
	if form.validate_on_submit():
		select_photo=form.photo.data		
		current_user.name=form.name.data
		current_user.location=form.location.data
		current_user.about_me=form.about_me.data
		current_user.avatar='photos/'+select_photo+'.jpg'
	...
	return render_template('edit_profile.html',form=form,photos=photos)
...
def followers(username):
	...
	return render_template('followers.html',user=user,title=u'被以下用户关注',endpoint='.followers',pagination=pagination,follows=follows)
